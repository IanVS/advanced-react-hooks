...
- The third argument to `useReducer` is a lazy initializer. It gets the value of
  the second argument, and whatever it returns will be the initial value of the
  reducer.
